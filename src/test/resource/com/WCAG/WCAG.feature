...
Feature: updated in stuff.
  ...
  Scenario Outline: Erase Previous Data
    ...
    Examples: 
      ...
      | TSSAdmin   | AC CHECKER  | UserNameInput | PasswordInput | jbradley | Dbresults1 |
  ...
  Scenario Outline: WCAG Analysis Login and Registration
    ...
    And I check I am on "Sign In" page
    And I capture "html"
    ...
    Then I write "Sign In Admin" information to file
    # LOGIN SCREEN
    ...
    And I click on button "validate_paste"
    And I capture "AC_num_of_errors"
    Then I write "Sign In" information to file
    #
    ...
    Examples: 
      ...
      | TSSAdmin   | AC CHECKER  | 85085664197 |      400107 | 21006819692 | TOYOTA SUPER PTY LTD | jbradley | Dbresults1 | wcag_automation9 | wcag4@automation.com |
  ...
  Scenario Outline: WCAG Forms: Tax Registration, User Settings
    ...
    Examples: 
      ...
      | TSSAdmin   | AC CHECKER  | UserNameInput | PasswordInput | jbradley | Dbresults1 | Bye Debts Pty Ltd |
  ...
  Scenario Outline: Payroll Tax Lodgement Form
    ...
    Examples: 
      | PortalName | PortalName2 | UserNameField | PasswordField | UserName | Password   | PayrollName          |
      | TSSAdmin   | AC CHECKER  | UserNameInput | PasswordInput | jbradley | Dbresults1 | QUICK SINGLE PTY LTD |
  ...
  Scenario Outline: Utilities Network Facilities Tax
    ...
    Then I select "01 Apr 2014 - 31 Mar 2015" from "ObligationsDropdown"
    ...
    #Then I click on button "Content_wtObligationsDropdown"
    #Then I click on "2014"
    Then I select "01 Apr 2014 - 31 Mar 2015" from "Content_wtObligationsDropdown"
    Then I click on button "SaveNextBT"
    Then I wait for "5000" millisecond
    Then I select "Water Network" from "NetworkDetail_UtilityTypeDropdown"
    Then I enter the details as
  ...
  Scenario Outline: Update Business Address
    ...
    Examples: 
      ...
      | TSSAdmin   | AC CHECKER  | jbradley | Dbresults1 | Bye Debts Pty Ltd |
  ...
  Scenario Outline: Tax Registration Cancellation
    ...
    Examples: 
      | PortalName | PortalName2 | UserName | Password   | BusinessName |
      | TSSAdmin   | AC CHECKER  | jbradley | Dbresults1 | AQUA         |
  ...
  Scenario Outline: Update Liability Commencement Date Request
    ...
    Then I click on button "SummarySubmitBT"
    Then I wait for "5000" millisecond
    Then I check I am on "Update Liability Commencement Date Request Confirmation" page
    And I capture "html"
    And I want to login to portal "<PortalName2>"
    And I click on "Paste HTML Markup"
    And I click on button "checkpaste"
    ...
    Examples: 
      | PortalName | PortalName2 | UserName | Password   | BusinessName      |
      | TSSAdmin   | AC CHECKER  | TSSAdmin | Dbresults1 | Bye Debts Pty Ltd |
  ...
  Scenario Outline: Generic Request Form
    ...
    Examples: 
      ...
      | TSSAdmin   | AC CHECKER  | UserNameInput | Bye Debts Pty Ltd | TSSAdmin | Dbresults1 |
  ...
  Scenario Outline: Credit Transfer Authorization
    ...
    And I hit Enter
    Then I click on "Service Requests"
    Then I click on "Credit Transfer Authorisation"
    Then I click on button "select2-chosen-1"
    Then I enter the details as
      | Fields               | Value          |
      | s2id_autogen1_search | <BusinessName> |
    ...
    Examples: 
      | PortalName | PortalName2 | UserName | Password   | BusinessName         |
      | TSSAdmin   | AC CHECKER  | TSSAdmin | Dbresults1 | TAGCORP PTY. LIMITED |
  ...
  Scenario Outline: Group Management
    ...
    Examples: 
      | PortalName | PortalName2 | UserNameField | PasswordField | UserName | Password   |
      | TSSAdmin   | AC CHECKER  | UserNameInput | PasswordInput | TSSAdmin | Dbresults1 |

  @review
  Scenario Outline: DTSP-870: Ambulance Levy Amendment
    Given I want to login to portal "<PortalName>"
    And I enter the details as
      | Fields        | Value      |
      | UserNameInput | <UserName> |
    ...
    And I click on button "validate_paste"
    And I capture "AC_num_of_errors"
    Then I write "Ambulance Levy Amendment Form" information to file
    #Summary
    Given I want to login to portal "<PortalName>"
    Then I click on "Return History"
    Then I click on button "select2-chosen-1"
    ...
    And I click on button "validate_paste"
    And I capture "AC_num_of_errors"
    Then I write "Ambulance Levy Amendment Summary" information to file
