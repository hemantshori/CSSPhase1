...
Feature: Regression for TSS.
	...
	#STORIES DONE: DTSP 25, 54, 55, 56, 57, 145, 147, 233, 318, 380, 392, 430 (LOCAL ONLY) 440, 441, 444, 459, 460, 463, 501, 506, 508,  523, 524
								#526, 531, 536, 537, 553 566	
  ...
  Scenario Outline: DTSP-55 : As a DB Portal Administrator I want to edit a message's description so that I can customise the description for an organisation
    ...
    Examples: 
      ...
      | TSS        | UserNameInput | PasswordInput | mbrown      | dbresults | FeedbackMsgText | InvalidRegistrationDetails |
  ...
  Scenario Outline: DTSP-56 :As a DB Portal Administrator I want to add a new message so that required messages are displayed in the portal
    ...
    Examples: 
      ...
      | TSS        | UserNameInput | PasswordInput | mbrown      | Dbresults1 | Are you sure you want to delete? | FeedbackMsgText | InvalidRegistrationDetails |
  ...
  Scenario Outline: DTSP-461: Update the Capture User Details page
    ...
    Then I enter the details as
      | Fields                  | Value       |
      | InputABNNumber_Business | 27163065852 |
      | InputCRNNumber_Business | 400017 |
    Then I click on button "TermsandConditionsCheckBox2"
    Then I click on button "RegistrationSubmit"
    Then I check I am on "Complete Registration" page
    Then "<Item>" is displayed as "<ItemName>"
      | Item  | ItemName           |
      | item1 | Client Reference Number (CRN) |
      | item1 | Australian Business Number (ABN) |
      | item1 | Business Name 			|
